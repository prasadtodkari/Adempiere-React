...
import { Grid, Basket, CartCheck, Shop, CashCoin, GraphUp, Palette2, MenuButtonWide, ChevronDown, FileEarmarkPlus, FileText } from "react-bootstrap-icons";
function sideBar() {
    const role = JSON.parse(localStorage.getItem('detail')).type;
            ...
            {role === 'user' ? <div>
                ...
                <aside id="sidebar" className="sidebar">
                    ...
                    <ul className="sidebar-nav" id="sidebar-nav">
                        ...
                        <li className="nav-heading">Purchase</li>
                        ...
                        <li className="nav-item">
                            ...
                            <ul id="components-nav" className="nav-content collapse show" data-bs-parent="#sidebar-nav">
                                ...
                                <li>
                                    <a href="components-modal.html" className="active">
                ...
                <aside id="sidebar" className="sidebar">
                    ...
                    <ul className="sidebar-nav" id="sidebar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link " data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                                <MenuButtonWide style={{marginRight: "10px", fontSize : "16px"}}/><span>Projection</span><ChevronDown className='ms-auto' />
                            </a>
                            <ul id="components-nav" className="nav-content collapse show" data-bs-parent="#sidebar-nav">
                                <li>
                                    <a href="components-alerts.html">
                                        <FileEarmarkPlus /><span className='ms-2'>New Projection</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="components-accordion.html">
                                        <FileText /><span className='ms-2'>Modify Projection</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
